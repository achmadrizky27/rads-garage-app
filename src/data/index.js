...
export const gallery = [
  ...
  },
  {
    id: 2,
    brand: "Honda",
    type: "BeaT Sporty Deluxe 110",
    category: "Modifikasi",
    images: ["/images/gallery/hondaBeat-1-(1).jpg", "/images/gallery/hondaBeat-1-(2).jpg"],
  },
  {
    id: 3,
    brand: "Yamaha",
    type: "Jupiter MX 135",
    category: "Modifikasi",
    images: ["/images/gallery/yamahaJPMX-1-(1).jpg", "/images/gallery/yamahaJPMX-1-(2).jpg"],
  },
  {
    id: 4,
    brand: "Honda",
    type: "BeaT Sporty CBS 110",
    category: "Servis Rutin",
    images: ["/images/gallery/hondaBeat-2-(1).jpg", "/images/gallery/hondaBeat-2-(2).jpg"],
  },
  {
    id: 5,
    brand: "Honda",
    type: "BeaT Sporty CBS 110",
    category: "Servis Rutin",
    images: ["/images/gallery/hondaBeat-3-(1).jpg", "/images/gallery/hondaBeat-3-(2).jpg"],
  },
  {
    id: 6,
    brand: "Suzuki",
    type: "Satria R 120",
    category: "Servis Rutin",
    images: ["/images/gallery/suzukiR-1-(1).jpg", "/images/gallery/suzukiR-1-(2).jpg", "/images/gallery/suzukiR-1-(3).jpg"],
  },
  {
    id: 7,
    brand: "Honda",
    type: "Repsol Blade 125",
    category: "Servis Rutin",
    images: ["/images/gallery/hondaRepsolBlade-1-(1).jpg", "/images/gallery/hondaRepsolBlade-1-(2).jpg"],
  },
  {
    id: 8,
    brand: "Suzuki",
    type: "Thunder 125",
    category: "Repair Machine",
    images: ["/images/gallery/suzukiThunder-1-(1).jpg"],
  },
  {
    id: 9,
    brand: "Yamaha",
